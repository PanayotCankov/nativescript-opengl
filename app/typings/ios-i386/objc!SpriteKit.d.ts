...
declare class SKUniform extends NSObject implements NSCoding, NSCopying {
	...
	static uniformWithNameFloatMatrix2(name: string, value: GLKMatrix2): SKUniform;

	static uniformWithNameFloatMatrix3(name: string, value: GLKMatrix3): SKUniform;

	static uniformWithNameFloatMatrix4(name: string, value: GLKMatrix4): SKUniform;

	static uniformWithNameFloatVector2(name: string, value: GLKVector2): SKUniform;

	static uniformWithNameFloatVector3(name: string, value: GLKVector3): SKUniform;

	static uniformWithNameFloatVector4(name: string, value: GLKVector4): SKUniform;
	...
	constructor(o: { name: string; floatMatrix2: GLKMatrix2; });

	constructor(o: { name: string; floatMatrix3: GLKMatrix3; });

	constructor(o: { name: string; floatMatrix4: GLKMatrix4; });

	constructor(o: { name: string; floatVector2: GLKVector2; });

	constructor(o: { name: string; floatVector3: GLKVector3; });

	constructor(o: { name: string; floatVector4: GLKVector4; });
